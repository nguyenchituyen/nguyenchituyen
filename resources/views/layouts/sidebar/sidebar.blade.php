        ...
        <ul class="sidebar-menu">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    ...
                    <li><a class="" href="{{ route('job.indexTag')}}">Tags Management</a></li>
                    <li><a class="" href="{{ route('job.createTag') }}">Register Tags</a></li>
                    <li><a class="" href="{{ route('job.apply') }}">Candidate Apply Job</a></li>
                </ul>
            </li>
            <li class="sub-menu">
                <a href="javascript:;" class="">
                ...
                <ul class="sub">
                    <li><a class="" href="{{ route('cultural.create') }}">Cultural Register</a></li>
                    <li><a class="" href="{{ route('cultural.index') }}">Cultural Management</a></li>
                </ul>
            </li>
            <li class="sub-menu">
                <a href="javascript:;" class="">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    <li><a class="" href="{{ route('about.edit','1') }}">Introduce Edit</a></li>
                </ul>
            </li>
        </ul>
        <!-- sidebar menu end-->
